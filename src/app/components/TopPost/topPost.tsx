...
const post = {
  ...
  return (
    <div className="font-normal text-medium">
      <h2 className="text-ml text-center uppercase font-bold">
        people love to visit
      </h2>
      <div className="flex gap-[38px] font-normal text-medium mt-12 ">
        <Image src={post.photo} alt="..." width={600} height={600} className="rounded-3xl"></Image>
        <div>
