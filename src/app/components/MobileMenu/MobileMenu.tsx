...
export default function MobileMenu() {
  ...
  return (
    <div className="py-4 h-auto top-10 right-10">
      ...
      <div className={`xl:hidden fixed w-[50%] h-[60%] right-[10%] md:right-[15%] top-28 z-1 font-extra font-bold uppercase text-xl text-white bg-orange_light shadow-xl rounded-3xl ${isOpen ? "block" : "hidden"}`}>
