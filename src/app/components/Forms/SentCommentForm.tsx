  ...
  return (
    <div>
      <form className="md:flex items-center md:gap-6 ">
        ...
        <div className=" xl:w-[900px] md:w-[400px]  w-44">
          <textarea placeholder='What are your thoughts?' className=" xl:w-[900px] md:w-[400px]  w-44 xl:h-[150px] bg-peach_light rounded-md text-white p-4 placeholder:text-grey_text"></textarea>
