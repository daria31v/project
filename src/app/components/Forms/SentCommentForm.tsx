  ...
  return (
    <div>
      <form className="md:flex items-center md:gap-6 ">
        ...
        <div className="">
          <textarea placeholder='What are your thoughts?' className="xl:w-[767px] md:w-[600px]  w-44 xl:h-[150px] bg-peach_light rounded-md text-white p-4 placeholder:text-grey_text"></textarea>
          
          <div className=" flex gap-3 justify-end items-end xl:w-[767px] md:w-[600px] mt-2">
