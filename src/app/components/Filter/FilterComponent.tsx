  ...
  return (
    <div>
      ...
      <div className="xl:flex xl:items-center grid md:grid-cols-5 grid-cols-2 gap-3">
        ...
        <label key={partner.id} className="mr-2 rounded-md h-8 inline-block md:px-3 px-1 py-1 text-center cursor-pointer bg-white  text-duna text-small font-normal hover:bg-secondary hover:text-pink hover:font-bold hover:shadow-md focus:shadow-md">
