...
export const metadata: Metadata = {
  ...
  description:
    'Welcome to our Insights & Tips section, a treasure trove of enlightening blog posts and practical tips curated to enhance your journey. Delve into a wealth of information, from engaging narratives to actionable advice, designed to enrich your experiences and empower your adventures.',
}
  ...
  return (
    <section className=" xl:px-[100px] py-16 md:px-12 px-6 bg-section-texture bg-cover bg-center bg-no-repeat">
      ...
      <div className="flex justify-between">
        <p className="text-secondary text-medium uppercase">
          Insights & Tips: <br /> Your go-to for valuable blog posts and helpful tips
        </p>
