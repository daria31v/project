    ...
    <section className="py-16 xl:px-[100px] md:px-12 px-6 bg-section-texture bg-cover bg-center bg-no-repeat">
      <div className="grid justify-around">
        ...
        <p className="max-w-[469px] font-normal text-primary text-center text-medium">
          Through visual storytelling, we invite you to embark on a journey with us a celebration of
          moments, cultures, and the art of sharing experiences.
        </p>
      </div>
      ...
      <div className="xl:grid xl:grid-cols-2 xl:gap-20 xl:my-16">
        <div className="max-w-full">
          ...
          <p className="text-justify font-normal text-medium text-primary indent-8">
            ...
            desire to share these ences. Driven by our fervor for capturing moments and exploring
            the world through our lens, we envisioned this project as a means to encapsulate the
            beauty and stories we encounter. Through our combined efforts, we aspire to inspire and
            connect with others who share our love for photography and wanderlust. Join us on this
            journey as we celebrate the art of storytelling through images and narratives, embracing
            the belief that experiences are meant to be shared and cherished.{' '}
          </p>
        </div>
