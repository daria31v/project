        ...
        <section className=" xl:grid xl:grid-cols-2 sm:block text-center py-20 xl:gap-12">
          <div>
            ...
            <h2 className="text-base font-bold mb-16 text-center">
              Share your experience with photos. Let’s discover your next
              journey from others!
            </h2>
            <p className="text-medium font-normal text-justify font-extra mb-10 xl:mb-0">
              ...
              libero, a pharetra augue. Hi omnes lingua, institutis, legibus
              inter se differunt. Quid securi etiam tamquam eu fugiat nulla
              pariatur. Cras mattis iudicium purus sit amet fermentum.Gallia est
              omnis divisa in partes tres, quarum. Fabio vel iudice vincam, sunt
              in culpa qui officia. Salutantibus vitae elit
            </p>
          </div>
          {/* slider */}
